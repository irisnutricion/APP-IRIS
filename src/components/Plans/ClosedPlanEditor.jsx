        ...
        >
            ...
            {viewMode === 'grid' && (
                <>
                    ...
                    {/* Day-by-day Accordion Editor */}
                    <div className="mt-8 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden shadow-sm">
